const MercedezBenz = (props) => (
  ...
  >
    <style>
      {".st3{fill:#fff}.st5{fill:#565f64}.st7{fill:#a4aaae;fill-opacity:.6}"}
    </style>
    <linearGradient
      id="outer_1_"
      x1={7.998}
    ...
    />
    <path
      d="M30.8 5.3v1.3l-2.2 22.1c0 .3.1.6.4.8l1.3 1 .9-24.4.1-1.9c-.3.2-.4.6-.5 1.1zm-1.2 25.6-1.2-1L8.1 44.6s-.6.4-.7.8l.7-.4 21.3-13.4c.4-.2.5-.4.2-.7z"
      className="st7"
    />
    <path
